...
console.error("Running hook to add aps entitlements");
...
var xcode = require('xcode'),
  ...
  fs.readdir(iosFolder, function (err, data) {
    ...
    if (fs.existsSync(destFile)) {
      ...
      var sourceFile = path.join(context.opts.plugin.pluginInfo.dir, 'src/ios/resources/aps.entitlements');
      fs.readFile(sourceFile, 'utf8', function (err, data) {
        ...
        console.error("Added aps entitlements to project '" + projName + "'");
